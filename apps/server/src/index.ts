...
fastify.get('/health',async()=>({ok:true,tick:simulation.state.tick,mode:simulation.state.ai.mode,provider:simulation.state.ai.provider,configured:simulation.state.ai.configured,pending:simulation.state.ai.pending,savedTick:lastSavedTick}));

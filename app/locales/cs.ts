...
export const cs = {
  ...
  controls: { pause: 'Pozastavit simulaci', resume: 'Pokračovat v simulaci', running: 'SVĚT BĚŽÍ', paused: 'SVĚT JE POZASTAVEN', reconnecting: 'OBNOVUJE SE SPOJENÍ', mock: 'MOCK', livingMind: 'ŽIVÁ MYSL' },
  ...
  inspector: { inhabitant: 'OBYVATEL', lifeHistory: 'ŽIVOTNÍ HISTORIE', life: 'ŽIVOT', back: 'ZPĚT', age: 'VĚK', currentIntention: 'AKTUÁLNÍ ZÁMĚR', thoughtSummary: 'Shrnutí myšlenky', motivations: 'Aktuální motivace', relevantMemories: 'Relevantní vzpomínky', recentExperiences: 'Nedávné zkušenosti', lastReflection: 'Poslední reflexe', aiState: 'Stav AI', noReflection: 'Zatím bez významné reflexe.', physicalImpressions: 'Tělesné pocity', importantMemories: 'Důležité vzpomínky', beliefs: 'Přesvědčení a hypotézy', noBeliefs: 'Zatím nemá ustálená přesvědčení; osobních důkazů je stále málo.', questions: 'Otázky, které si klade', skills: 'Naučené dovednosti', noSkills: 'Zatím nevznikl žádný opakovatelný postup.', knownPeople: 'Vztahy a dojmy', viewLife: (name:string)=>`ZOBRAZIT ŽIVOTNÍ HISTORII: ${name.toUpperCase()}`, confidence: (value:number)=>`jistota ${Math.round(value*100)} %` },
  research: { layer: 'POZOROVATELSKÁ VÝZKUMNÁ VRSTVA', note: 'Jde o pozorování, nikoli skóre nebo cíle postupu.', population: 'Obyvatelé', conversations: 'Rozhovory', experiments: 'Pokusy', structures: 'Stavby', regions: 'Navštívené oblasti', personalBeliefs: 'Osobní přesvědčení', aiDecisions: 'AI rozhodnutí', reflections: 'Reflexe', beliefChanges: 'Změny přesvědčení', questionsCreated: 'Nové otázky', questionsRevisited: 'Znovu otevřené otázky', intentionsCompleted: 'Dokončené záměry', intentionsAbandoned: 'Opuštěné záměry', contradictions: 'Rozpory v přesvědčení', knowledgeTransfers: 'Předání znalostí', fallbackDecisions: 'Náhradní rozhodnutí', averageLatency: 'Průměrná odezva AI', milliseconds: 'ms', perAgent: 'Porovnání obyvatel', actions: 'činností', memories: 'vzpomínek', questions: 'otázek', concepts: 'pojmů', relationships: 'vztahů', regionsShort: 'oblastí', partners: 'partnerů v rozhovoru', currentIntention: 'Záměr', markers: 'Výzkumné milníky', noMarkers: 'Svět zatím nevytvořil žádnou první událost, kterou by stálo za to označit.', activeQuestions: 'Aktivní otázky', firstUsed: 'POPRVÉ POUŽITO', knownBy: (count:number)=>`Zná ${count} ${count===1?'obyvatel':count>=2&&count<=4?'obyvatelé':'obyvatel'}`, noConcepts: 'Žádný obyvatel zatím nepojmenoval nový pojem. Názvy se šíří pouze pozorováním a rozhovorem.' },
  debug: { individuality: 'Diagnostika individuality', variation: 'variabilita chování', converging: 'Obyvatelé se začínají chovat podobně. Tlak na narušení opakování je aktivní.', homogenized: (count:number,total:number)=>`${count}/${total} obyvatel má stejný převládající typ nedávné činnosti.`, distinct: 'Historie činností zůstávají smysluplně odlišné.', keys: { tick: 'simulační tik', selected: 'vybraný obyvatel', perceptionRadius: 'poloměr vnímání', currentAction: 'aktuální činnost', thoughtSummary: 'stručné shrnutí úvahy', aiMode: 'režim AI', aiProvider: 'poskytovatel AI', aiStatus: 'stav AI', aiPending: 'čekající požadavky', aiRequests: 'počet požadavků', aiFallbacks: 'náhradní rozhodnutí', aiAverageLatency: 'průměrná odezva', retrievedMemories: 'vybavené vzpomínky', beliefs: 'přesvědčení', path: 'plánovaná cesta', experienceRecords: 'záznamy zkušeností', actionType: 'typ', actionTarget: 'cíl', actionObject: 'předmět', actionDescription: 'popis', actionPerson: 'cílový obyvatel', actionSpeech: 'řeč', beliefStatus: 'stav', beliefStatement: 'tvrzení', beliefEvidence: 'důkazy', beliefConfidence: 'jistota', beliefUpdated: 'poslední změna' } },
...
export const aiStatusLabels={idle:'nečinná',queued:'čeká ve frontě',thinking:'přemýšlí',backoff:'čeká po chybě'} as const;
export const providerLabel=(provider:string)=>provider==='deterministic-cognitive-core'||provider==='mock'?'Deterministické kognitivní jádro':provider==='openai-compatible'?'Poskytovatel kompatibilní s OpenAI':provider;
